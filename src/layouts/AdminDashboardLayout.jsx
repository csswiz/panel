...
export const AdminDashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-rose-500 selection:text-white transition-colors duration-300 mesh-bg">
      ...
      <div className="bg-gradient-to-r from-rose-600 via-purple-600 to-indigo-600 text-white text-[11px] font-bold py-1.5 px-4 text-center flex items-center justify-center gap-2 tracking-wider uppercase animate-gradient-x relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent animate-gradient-x" style={{ backgroundSize: "200% 100%", animationDuration: "3s" }} />
