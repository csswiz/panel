      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className={`relative w-full ${maxWidth} shadow-2xl rounded-2xl border border-slate-200/60 dark:border-slate-800 bg-white/98 dark:bg-slate-900/98 backdrop-blur-xl p-6 z-10 card-accent-top`}
          >
            {/* Inner glow */}
